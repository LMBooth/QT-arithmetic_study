...
from marker_extraction import extract_arithmetic


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Extract arithmetic marker streams from XDF into CSVs and events TSVs."
    )
    parser.add_argument(
        "--xdf-dir",
        default=str(Path("Arithmetic_Data") / "sourcedata"),
        help="Directory containing arithmetic XDF files.",
    )
    parser.add_argument(
        "--markers-dir",
        default="markers_arithmetic",
