...
def main() -> None:
    ...
    parser.add_argument("--bids-root", required=True, help="BIDS dataset root (e.g., bids_arithmetic).")
    parser.add_argument("--task", required=True, help="BIDS task label (e.g., arithmetic).")
